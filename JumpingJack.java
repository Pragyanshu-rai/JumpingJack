...
class Motion extends JPanel implements ActionListener,KeyListener
{
	public String msg = new String("    SCORE :- "),msg1=new String("");
	public JFrame fr = new JFrame("Jumping Jack");
...
public class JumpingJack extends Thread
{
	public static JumpingJack gameFrame = new JumpingJack();
